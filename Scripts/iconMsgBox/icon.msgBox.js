    ...
    $.iconMsgBox = function (setting) {
        ...
        var myBox = {
            ...
            _show: function (obj) {
                ...
                if (self.option.target != "" && self.option.target != undefined) {
                    $(self.option.target).append(obj);
                }
                else {
                    $('body').append(obj);
                }
            ...
            _close: function (obj) {
                ...
                // hide Box
                obj.parent().parent().hide(function () {
